...
export class BlogListComponent {
    ...
    totalBlogs: Blog[] = [
        {
            coverImage: "assets/demo/images/blog/wifi-article.png",
            profile: "assets/demo/images/avatar/circle/avatar-f-1.png",
            title: "Wifi",
            description: "Nous allons passer en revue les points forts du réseau WiFi pour connecter différents objets.",
            comment: 2,
            share: 7,
            day: "15",
            month: "October"
